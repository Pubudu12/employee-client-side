...
import { updateEmployee, fetchEmployee } from '@/app/redux/features/slices/employeeSlice';
...
function Edit() {
    ...
    const employee = useSelector((state: RootState) => state.employee.entities.find((emp : any) => emp.id === id));
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!firstNameError && !lastNameError && !emailError && !phoneError ) {
            ...
            setNotification({color: "green", message: "Employee updated successfully!"})
        } else {
            console.log('Form has validation errors. Please fix them.');
            setNotification({color: "red", message: "Employee update Failed!"})
        }
    };
